...
import '../shopsScreen/order.dart';
import 'addBarberProduct.dart';



class BarberProductsScreen extends StatefulWidget {
   const BarberProductsScreen({super.key,required this.shopname,required this.barbername,required this.barberid});
...
class _BarberProductsScreenState extends State<BarberProductsScreen> {
  ...
  Widget build(BuildContext context) {
    products=AppCubit.get(context).Barberproducts;
        ...
        builder: (context, state) {
          ...
          Scaffold(
              ...
              children: [
                ...
                Expanded(
                  child: ConditionalBuilder(
                    condition: state is! GetProductsBarberLoadingState,
           ...
           :Text('no items'),
            ...
            floatingActionButton: FloatingActionButton(onPressed: (){navigateTo(context, AddBarberProductScreen(shopname: widget.shopname));},child: Icon(Icons.add,color: kPrimaryColor,),backgroundColor: kPrimaryColor2,),
          )
              :
